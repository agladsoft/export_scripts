...
xls_path="${XL_IDP_PATH_EXPORT}/lines_${XL_IMPORT_TERMINAL}/flat_export_${XL_IMPORT_TERMINAL}"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_ROOT_EXPORT}/scripts_for_bash_with_inheritance/flat_export.py "${csv_name}" "${json_path}"
